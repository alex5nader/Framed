...
//// */
////abstract class BaseFrame: BlockWithEntity() {
////    companion object {
////        /**
...
////        } else if (playerStack.item is BlockItem && playerStack.item != frameEntity.item && (playerStack.item as BlockItem).block !is BaseFrame) {
