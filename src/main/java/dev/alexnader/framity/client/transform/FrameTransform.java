...
import dev.alexnader.framity.block.frame.data.FrameData;
import dev.alexnader.framity.client.assets.overlay.Overlay;
...
import static dev.alexnader.framity.client.FramityClient.CLIENT_OVERLAYS;
import static dev.alexnader.framity.client.util.QuadUtil.calcCenter;
import static dev.alexnader.framity.util.FunctionalUtil.*;
