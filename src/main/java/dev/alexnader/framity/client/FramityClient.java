...
import dev.alexnader.framity.client.assets.OverlayAssetListener;
import dev.alexnader.framity.client.assets.overlay.OffsetterRegistry;
import dev.alexnader.framity.client.assets.overlay.ZeroOffsetter;
import dev.alexnader.framity.client.gui.FrameScreen;
import dev.alexnader.framity.client.transform.FrameTransform;
...
public class FramityClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        FramityClient.CODECS = new FramityCodecs();
